  ...
  return (
    <Collapse in={visible}>
      <div className="mb-4" id="query-modifiers">
        <div className="row">
          <div className="ms-4">
            <input type="checkbox" value={mods.recentCheckIns} onChange={() => handleClick('recentCheckIns')} />
          ...
          <div className="ms-4">
            <input type="checkbox" value={mods.excludeDroplets} onChange={() => handleClick('excludeDroplets')} />
          ...
          <div className="ms-4">
            <input type="checkbox" value={mods.stage2Only} onChange={() => handleClick('stage2Only')} />
          ...
          <div className="ms-4">
            <input type="checkbox" value={mods.excludeStage2} onChange={() => handleClick('excludeStage2')} />
